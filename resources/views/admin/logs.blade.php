...
@section('content')
    ...
    <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
        <div class="card-header bg-white py-3 d-print-block">
            <h5 class="mb-0 fw-bold"><i class="bi bi-journal-text text-primary me-2"></i>Báo cáo Hoạt động Nhật ký
            </h5>
            <small class="text-muted d-print-block">Xuất ngày: {{ now()->format('d/m/Y H:i') }} | Người xuất:
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4 d-print-none">
                                    <button class="btn btn-sm btn-link text-decoration-none" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#logDetail{{ $log->id }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-5 text-muted">Chưa có nhật ký hoạt động nào.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
