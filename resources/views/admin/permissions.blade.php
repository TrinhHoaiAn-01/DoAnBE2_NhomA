                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="form-check form-switch d-flex justify-content-center">
                                    ...
                                    <input class="form-check-input" type="checkbox" role="switch" name="permissions[{{ $role->id }}][can_view]" value="1" {{ $role->can_view ? 'checked' : '' }}>
                                </div>
                            </td>
                            <td class="text-center">
                                <div class="form-check form-switch d-flex justify-content-center">
                                    <input type="hidden" name="permissions[{{ $role->id }}][can_add]" value="0">
                                    <input class="form-check-input" type="checkbox" role="switch" name="permissions[{{ $role->id }}][can_add]" value="1" {{ $role->can_add ? 'checked' : '' }}>
                                </div>
                            </td>
                            <td class="text-center">
                                <div class="form-check form-switch d-flex justify-content-center">
                                    <input type="hidden" name="permissions[{{ $role->id }}][can_edit]" value="0">
                                    <input class="form-check-input" type="checkbox" role="switch" name="permissions[{{ $role->id }}][can_edit]" value="1" {{ $role->can_edit ? 'checked' : '' }}>
                                </div>
                            </td>
                            <td class="text-center">
                                <div class="form-check form-switch d-flex justify-content-center">
                                    <input type="hidden" name="permissions[{{ $role->id }}][can_delete]" value="0">
                                    <input class="form-check-input" type="checkbox" role="switch" name="permissions[{{ $role->id }}][can_delete]" value="1" {{ $role->can_delete ? 'checked' : '' }}>
                                </div>
                            </td>
                            <td class="text-center">
                                <div class="form-check form-switch d-flex justify-content-center">
                                    <input type="hidden" name="permissions[{{ $role->id }}][can_approve]" value="0">
                                    <input class="form-check-input" type="checkbox" role="switch" name="permissions[{{ $role->id }}][can_approve]" value="1" {{ $role->can_approve ? 'checked' : '' }}>
                                </div>
                            </td>
                        </tr>
                        @endforeach
